            ...
            >
                {({errors, touched}) => {
                    ...
                    <Form className='mt-10'>
                        ...
                        <input type="submit" value="Agregar Cliente" className='mt-5 w-full bg-blue-800 p-3 text-white uppercase font-bold text-lg hover:cursor-pointer hover:bg-blue-700 transition-all' />
                    </Form>
                )}}
            </Formik>
        </div>
