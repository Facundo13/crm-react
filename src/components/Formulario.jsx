                        ...
                        return (
                            <Form className='mt-10'>
                                ...
                                <div className='mb-4'>
                                    ...
                                    <Field as="textarea" id="notas" type="text" className="mt-2 block w-full p-3 bg-gray-50" placeholder="Notas del cliente" name="notas" />
                                </div>
                                <input type="submit" value={cliente?.nombre ? 'Editar Cliente' : 'Agregar Cliente'} className='mt-5 w-full bg-blue-800 p-3 text-white uppercase font-bold text-lg hover:cursor-pointer hover:bg-blue-700 transition-all' />
                            </Form>
                        )
                    }}
                </Formik>
